# Generated by Powerlevel10k configuration wizard on 2023-11-02 at 21:10 EDT.
...
# angled separators, sharp heads, round tails, 2 lines, solid, full frame, compact,
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%240F╰─%F{blue} \uf1d0 %f %F{yellow}❯ '
